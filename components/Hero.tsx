    ...
    <div className="relative w-full px-5 py-24 mx-auto max-w-6xl sm:px-6 md:py-32 z-10">
      <div className="flex flex-col-reverse items-center gap-12 md:flex-row md:justify-between">
        ...
        <div className="flex flex-col items-center md:items-start gap-5 text-center md:text-left max-w-xl">
          ...
          {/* Name */}
          <h1
            className="font-extrabold text-5xl sm:text-6xl lg:text-7xl tracking-tight bg-gradient-to-r from-indigo-400 via-violet-500 to-purple-600 bg-clip-text text-transparent bg-[length:200%_auto] animate-shimmer animate-fade-in-up"
          ...
          >
            <SocialLink href="https://github.com/toantd90" label="Toan's GitHub">
            ...
            <SocialLink href="https://twitter.com/toantd90" label="Toan's Twitter">
              <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
            ...
            <SocialLink href="https://leetcode.com/annietran/" label="Toan's LeetCode">
            ...
            <SocialLink href="https://dev.to/toantd90" label="Toan's Dev.to">
              <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
            ...
            <SocialLink href="https://www.linkedin.com/in/toan-tran-duc/" label="Toan's LinkedIn">
              <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
            ...
            <SocialLink href="https://stackoverflow.com/users/3766872/toan-tran" label="Toan's Stack Overflow">
              <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
